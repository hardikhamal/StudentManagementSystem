            ...
            <div id="layoutSidenav_content">
                ...
                ?>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Update Subject</h1>
                        <form action="process/subupdate.php" method="post" class="form" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-2">Subject Name</div>
                                <div class="col-md-10"><input type="text" required name="subname" value="<?php echo $rows2['subname'] ?>" class="form-control form-control-sm"></div>
                                ...
                                <div class="col-md-10 mt-3"><input type="text" name="coursedu" value="<?php echo $rows2['coursedu'] ?>" class="form-control form-control-sm"></div>
                                <div class="col-md-2 mt-3">Course Fee</div>
                                <div class="col-md-10 mt-3"><input type="text" required name="fee" value="<?php echo $rows2['fee'] ?>" class="form-control form-control-sm"></div>
