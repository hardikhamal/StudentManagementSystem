                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <form action="#">
                            <div class="row">
                                <div class="col-md-3">
                                    <input type="text" id="nepalidate" name="startdate" placeholder="Input Starting Date" class="form-control form-control-sm">
                                </div>
                                <div class="col-md-3">
                                    <input type="text" id="nepalidate2" name="enddate" placeholder="Input Ending Date" class="form-control form-control-sm">
                                </div>
                        ...
                        <?php 
                            if(isset($_GET) && !empty($_GET)){
                                ...
                                $sql1 = "SELECT * FROM students WHERE dateofadmission >= '$startdate' and dateofadmission <= '$enddate'";
